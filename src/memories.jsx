...
//           >
//             <span className="material-symbols-outlined text-red-600/60 text-sm">
//               favorite
//             </span>
//             <h2 className="text-white font-serif text-xl ml-2 opacity-90">
//               Forever &amp; Always
//             </h2>
//           </div>
...
//         <div className="floating-message text-2xl top-[25%] left-[12%]">
//           "You are my calm in every storm"
//         </div>
//         <div className="floating-message text-2xl top-[35%] right-[12%]">
...
//               <span className="material-symbols-outlined text-[10px] text-red-600/50">
//                 favorite
//               </span>
//             </div>
//             <div className="h-[1px] w-16 bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent opacity-40" />
...
//             Where every reflection of light tells a story of the quiet love we
//             share beneath the midnight sky.
//           </p>
//         </div>
//       </header>
...
//               <img src={ourFam} className="w-full h-full object-cover" />
//             </div>
//             <h3 className="text-white text-2xl font-serif italic text-center">
//               Our Family
//             </h3>
//           </div>
...
//           <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
//             <div className="overflow-hidden rounded-lg mb-6 aspect-[4/5] border border-white/5">
//               <img src={temIm} className="w-full h-full object-cover" />
//             </div>
//             <h3 className="text-white text-2xl font-serif italic text-center">
//               Our Favorite
//             </h3>
...
//           <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
//             <div className="overflow-hidden rounded-lg mb-6 aspect-[4/5] border border-white/5">
//               <img src={handImg} className="w-full h-full object-cover" />
//             </div>
//             <h3 className="text-white text-2xl font-serif italic text-center">
//               Hand in Hand
//             </h3>
...
//           <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
//             <div className="overflow-hidden rounded-lg mb-6 aspect-[4/5] border border-white/5">
//               <img src={childImg} className="w-full h-full object-cover" />
//             </div>
//             <h3 className="text-white text-2xl font-serif italic text-center">
//               Cutest Memory
//             </h3>
...
//           <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
//             <div className="overflow-hidden rounded-lg mb-6 aspect-[4/5] border border-white/5">
//               <img src={vasImg} className="w-full h-full object-cover" />
//             </div>
//             {/* <h3 className="text-white text-2xl font-serif italic text-center">
//         Vasantha bhavan 
//       </h3> */}
...
//               Vasantha bhavan
//               <span className="inline-block hover:scale-125 transition-transform">
//                 😂
//               </span>
//             </h3>
//           </div>
...
//             <span className="material-symbols-outlined text-red-600/30">
//               favorite
//             </span>
//           </div>
//           <div className="h-[1px] w-24 bg-gold-accent/10" />
  ...
  return (
    <>
      ...
      <footer className="bg-midnight-black relative z-40 py-20 text-center border-t border-white/5">
        ...
        <p className="text-slate-500 text-[10px] font-bold tracking-[0.6em] uppercase">Midnight Moonlight Gallery • Established MMXXIV</p>
      </footer>
    </>
  );
}
