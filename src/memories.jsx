  ...
  <div className="masonry-grid">
    ...
    <div className="masonry-item">
      <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
        ...
        <h3 className="text-white text-2xl font-serif italic text-center">Our favorite</h3>
      </div>
    </div>
    ...
    <div className="masonry-item">
      <div className="card-dark p-5 rounded-xl shadow-2xl hover:-translate-y-2 transition-transform duration-500">
        ...
        <h3 className="text-white text-2xl font-serif italic text-center">Hand in Hand</h3>
      </div>
    </div>
  </div>
</main>
